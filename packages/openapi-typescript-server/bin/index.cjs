...
program.name("openapi-typescript-server").description("CLI to generate Open API server stub").version("0.0.1").argument("<spec>", "Path to Open API spec file").description("Output generated code").option(
  "-t, --types <types>",
